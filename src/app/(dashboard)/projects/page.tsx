...
import {
  FiPlus, FiSearch, FiGrid, FiList, FiEdit2, FiTrash2, FiX,
  FiCalendar, FiDollarSign, FiCheckCircle, FiClock, FiMoreVertical
} from 'react-icons/fi'
                    ...
                    <div className="relative">
                      ...
                      {openDropdown === project.id && (
                        <div className="absolute right-0 top-10 bg-white dark:bg-slate-800 rounded-xl shadow-xl border border-gray-100 dark:border-slate-700/50 py-2 z-20 min-w-[140px] animate-in zoom-in-95 duration-200">
                          <button
                            onClick={() => { openEditModal(project); setOpenDropdown(null) }}
                          ...
                          <button
                            onClick={() => { setShowDeleteConfirm(project.id); setOpenDropdown(null) }}
